...
export function createHeaderLogoAndSocialTemplate(): ContentBlock[] {
  const socialHTML = `<div style="display: flex; justify-content: space-between; align-items: center; padding: 20px 0; gap: 20px;">
    ...
    <div style="display: flex; gap: 12px; justify-content: flex-end; flex: 1;">
      <a href="#" title="Facebook" style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; text-decoration: none; color: #4267B2; transition: transform 0.2s;">
        <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
          <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z"/>
        </svg>
      </a>
      <a href="#" title="Twitter" style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; text-decoration: none; color: #000000; transition: transform 0.2s;">
        <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
      ...
      <a href="#" title="LinkedIn" style="display: inline-flex; align-items: center; justify-content: center; width: 40px; height: 40px; text-decoration: none; color: #0A66C2; transition: transform 0.2s;">
        <svg width="32" height="32" viewBox="0 0 24 24" fill="currentColor">
  ...
  return [createHtmlBlock(socialHTML)];
}
